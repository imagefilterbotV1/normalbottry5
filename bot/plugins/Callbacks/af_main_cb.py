...
async def callback_data(bot, update: CallbackQuery):
    ...
    if query_data == "start":
        buttons = [[
            InlineKeyboardButton('JOIN US 👨‍🔬', url='https://t.me/joinchat/BhYlk3vvhG5hMmZl'),
            InlineKeyboardButton('FOR ANY 🍿MOVIE'S🧾', url ='https://t.me/joinchat/BhYlk3vvhG5hMmZl')
        ],[
            InlineKeyboardButton('Support US ', url='https://t.me/joinchat/BhYlk3vvhG5hMmZl')
        ],[
